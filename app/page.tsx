        ...
        <div className="px-6 py-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <ThemeToggle />
              <Button className="bg-blue-600 hover:bg-blue-700">Refresh</Button>
        ...
        <div className="px-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="bg-transparent border-b border-border rounded-none p-0 h-auto w-full justify-start">
              <TabsTrigger 
                value="overview"
                className="rounded-none border-b-2 border-transparent px-4 py-4 data-[state=active]:border-blue-500 data-[state=active]:bg-transparent"
              >
                Overview
              </TabsTrigger>
              <TabsTrigger 
          ...
          <Card className="bg-card border-border p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                { label: 'Scheduled routine checks', count: 8, color: 'bg-blue-500' },
